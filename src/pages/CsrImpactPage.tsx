...
import { GraduationCap, MapPin, Users, Clock, RefreshCw, Bookmark, CheckCircle } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6">
        ...
        <aside className="space-y-4">
          ...
          <Card className="p-4">
            ...
            <div className="mt-2">
              <div className="text-sm font-medium">Community Leader</div>
              <div className="text-xs text-muted-foreground">Issued: 2025-11-01</div>
            </div>
          </Card>
