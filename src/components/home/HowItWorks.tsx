...
const audiences: Audience[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Campus branding across 100+ colleges",
      "Faster hiring & early talent access",
  ...
  },
  {
    ...
    features: [
      "Access high-potential student founders",
  ...
  {
    icon: Handshake,
    title: "For CSR, Non-Profit & Skill Development Centers",
    description: "Drive real impact beyond training.",
    features: [
      "Enable employability and income",
      "Connect beneficiaries to real opportunities",
      "Improve placement and livelihood outcomes",
      "Run co-branded programs",
      "Access corporate and startup ecosystems",
